...
export class SatusehatController {
  ...
  @Get('stats')
  @ApiOperation({ summary: 'Dashboard statistik sync SATUSEHAT' })
  getStats() { return this.service.getSyncStats(); }

  @Post('sync/:encounterId')
  @Roles('ADMIN', 'IT', 'DOKTER')
  @ApiOperation({ summary: 'Sync encounter + resources ke SATUSEHAT' })
  ...
  @Get('logs')
  @Roles('ADMIN', 'IT')
  @ApiOperation({ summary: 'Riwayat sync SATUSEHAT' })
  getLogs(
